...
import com.cyq7on.tranceroutlib.task.LDNetAsyncTaskEx;
...
public class LDNetDiagnoService extends
  ...
  private boolean _isUseJNICTrace = false;
...
//      recordStepInfo("\n开始traceroute..." + hop);
      ...
      _traceRouter.startTraceRoute(_dormain,hop);
      /*for (int i = 0; i < 30; i++) {
        _traceRouter = LDNetTraceRoute.getInstance();
        _traceRouter.initListenter(this);
        _traceRouter.isCTrace = this._isUseJNICTrace;
        _traceRouter.startTraceRoute(_dormain,i);
      }*/
